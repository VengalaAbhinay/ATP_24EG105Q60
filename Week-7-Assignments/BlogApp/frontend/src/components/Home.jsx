    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-violet-50">
      ...
      <div className="max-w-5xl mx-auto px-6 pb-24">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          {[
            { title: "Read Articles", desc: "Browse curated articles across technology, programming, AI, and more." },
            { title: "Join Discussions", desc: "Comment on articles and engage with authors and the community." },
            { title: "Like & Support", desc: "Show appreciation by liking articles from your favorite authors." },
          ].map((f) => (
